...
class PagingAdapter : PagingDataAdapter<String, PagingViewHolder>(diffCallback) {
    ...
    override fun onBindViewHolder(holder: PagingViewHolder, position: Int) { // PagingViewHolder, NetworkViewHolder
...
class PagingViewHolder(private val binding: ItemSampleBinding) : RecyclerView.ViewHolder(binding.root) {
